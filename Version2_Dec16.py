...
st.set_page_config(page_title='APEM WEB APP TEST', layout='wide')
...
def load_data():
    ...
    excel_data = pd.read_excel(
        "C:/Users/diana/Documents/4.TBS/MScAI-BusinessAnalytics/APEM PROJECT/Data/Data_Nov10.xlsx")
...
def main():
    ...
    for attribute in attribute_list:
        ...
        key += 1
        #result = attribute_code(data,family,attribute,value)
        #if result == "None":
            #result_str = ""
        #else:
    ...
    # Help Tool
    # For "Blue/White" the tool returns products with Blue/White, Blue and White
